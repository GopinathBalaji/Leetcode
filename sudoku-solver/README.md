<h2>37. Sudoku Solver</h2><h3>Hard</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Write a program to solve a Sudoku puzzle by filling the empty cells.</p>
