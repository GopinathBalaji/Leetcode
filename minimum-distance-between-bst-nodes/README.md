<h2>783. Minimum Distance Between BST Nodes</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given the <code style="user-select: auto;">root</code> of a Binary Search Tree (BST), return <em style="user-select: auto;">the minimum difference between the values of any two different nodes in the tree</em>.</p>
