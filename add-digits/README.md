<h2>258. Add Digits</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given an integer <code style="user-select: auto;">num</code>, repeatedly add all its digits until the result has only one digit, and return it.</p>
