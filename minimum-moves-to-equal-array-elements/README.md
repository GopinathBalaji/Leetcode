<h2>453. Minimum Moves to Equal Array Elements</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given an integer array <code style="user-select: auto;">nums</code> of size <code style="user-select: auto;">n</code>, return <em style="user-select: auto;">the minimum number of moves required to make all array elements equal</em>.</p>
