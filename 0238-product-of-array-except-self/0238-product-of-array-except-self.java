// Method 1: Using O(n) extra space while only pre-computing prefix array
/*
*/
class Solution {
...
// Method 2: Computing Prefix and Suffix Product Arrays (Uses O(2n) == O(n) extra space)
/*
*/
// class Solution {
//     public int[] productExceptSelf(int[] nums) {
