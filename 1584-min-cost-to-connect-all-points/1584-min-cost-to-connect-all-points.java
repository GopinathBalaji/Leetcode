...
// Method 1.5: My approach to the above Prim's Algorithms (MST)
/*
*/
// class Solution {
//     public int minCostConnectPoints(int[][] points) {
...
//                 if(visited[j] == 0 && minDist[j] < minDistVal){
//                     minDistVal = minDist[j];
//                     minDistIdx = j;
//                 }
//             }

//             visited[minDistIdx] = 1;
//             ans += minDistVal;

//             for(int k=0; k<minDist.length; k++){
//                 if(visited[k] == 0){
//                     minDist[k] = Math.min(minDist[k], getDistance(points, minDistIdx, k));
//                 }
//             }
//         }
...
//     private int getDistance(int[][] points, int index1, int index2){
